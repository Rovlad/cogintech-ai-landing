  ...
  return (
    <section id="testimonials" className="section bg-gradient-to-b from-background to-muted">
      <div className="container">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-border p-8 max-w-4xl mx-auto">
          ...
          <div className="mt-8 p-4 bg-cogintech-blue/5 rounded-lg border border-cogintech-blue/20 text-center">
